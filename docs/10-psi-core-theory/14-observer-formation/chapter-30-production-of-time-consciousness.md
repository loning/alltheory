---
sidebar_position: 30
title: "Chapter 30: The Production of Time Consciousness"
---
...
$$
\text{Time} = \text{Consciousness}(\psi_{t_1}) \to \text{Consciousness}(\psi_{t_2})
$$

Without consciousness to compare states, there is no time—only eternal $\psi = \psi(\psi)$.
...
$$
\text{Past} = \{\psi_i : i < \text{now}, \text{collapsed}\}
$$

**Present**: The active collapse edge
$$
\text{Present} = \text{Collapse}_{\text{occurring}}(\psi)
$$

**Future**: Potential states awaiting collapse
$$
\text{Future} = \{\psi_j : j > \text{now}, \text{potential}\}
$$
...
$$
\text{Flow} = \frac{d(\text{Collapse})}{d\tau} \text{ where } \tau \text{ is subjective time}
$$
...
$$
\Delta t_{\text{present}} \approx 100\text{-}300\text{ms}
$$
...
$$
\text{Temporal depth} = \int_{-\infty}^{\text{now}} \text{Memory}(\psi_t) \, dt
$$
...
$$
\text{Arrow of time} = \text{Gradient}(\text{Potential} \to \text{Actual})
$$
...
$$
T = \text{Awareness of }(\text{Awareness of }(\text{Change}))
$$
...
$$
t_{\text{subjective}} = f(\text{State of consciousness})
$$
...
$$
\text{Now} = \lim_{\Delta t \to 0} \text{Present}(t)
$$
...
$$
\text{Experience} = \int \text{Moment}(t) \cdot \text{Binding}(t,t') \, dt \, dt'
$$
