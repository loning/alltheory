...
$$
\text{Question} = \psi(\text{unknown})
$$
$$
\text{Answer} = \psi(\text{known})
$$
$$
\text{But: unknown} = \text{known}(\text{not-yet-observed})
$$
...
In our language:
$$
\text{Knowledge} = \psi(\psi(\text{ignorance}))
$$
