...
9. **[Free Will = Collapse Steering](./chapter-09-free-will-collapse-steering.md)** — Navigation in the Echo Field
10. **[Memory = Path Fixation](./chapter-10-memory-path-fixation.md)** — Retaining ψ Within Recursive Time
11. **[Emotion = Collapse Gradient](./chapter-11-emotion-collapse-gradient.md)** — Affective States as Echo Curvature
...
\text{Desire} &: D = \vec{v}(\text{Collapse Direction}) \\
\text{Attention} &: A = \text{Focus}(\psi \rightarrow \psi') \\
...
*Before will*: ψ collapses automatically.
*With will*: ψ chooses its collapse paths.
*As will*: You discover choice and choicelessness are one.
