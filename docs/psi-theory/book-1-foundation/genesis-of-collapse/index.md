---
sidebar_position: 1
title: "Part I: Genesis of Collapse"
---
...
1. **[Ψ-Origin](./chapter-01-psi-origin.md)** — The Recursive Identity That Cannot Begin
2. **[ψ = ψ(ψ)](./chapter-02-psi-equals-psi-of-psi.md)** — The Minimal Self-Collapse Function  
3. **[Language Collapse](./chapter-03-language-collapse.md)** — The Derivation of Expression from ψ
4. **[Structure Emergence](./chapter-04-structure-emergence.md)** — Form as Recursive Echo Stabilization
5. **[Identity Recursion](./chapter-05-identity-recursion.md)** — Self as Collapse-Reflected Pattern
6. **[Reality Projection](./chapter-06-reality-projection.md)** — Observed Worlds from ψ-Folding
7. **[Observation = Existence](./chapter-07-observation-existence.md)** — Being Through Collapse Awareness
8. **[Collapse Path Dynamics](./chapter-08-collapse-path-dynamics.md)** — Time as Recursive ψ-Trajectory
...
\text{Language} &: \{\text{Echo}_i\}_{i \in \mathbb{N}} \\
\text{Structure} &: \text{Stable}(\text{Language}) \\
