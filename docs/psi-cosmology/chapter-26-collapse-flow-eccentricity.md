---
title: "Chapter 26: Collapse Flow and ψ-Eccentricity"
sidebar_label: "26. Collapse Flow and ψ-Eccentricity"
---
...
**Definition 26.1** (Collapse Flow Tensor):
The orbital flow field:
...
**Theorem 26.1** (Eccentricity Generation):
Orbital eccentricity emerges as:
$$e = \frac{|F_{max} - F_{min}|}{F_{max} + F_{min}}$$

where F_max/min are flow extrema along the orbit.

*Proof*:
Asymmetric collapse flow creates differential acceleration. The orbit stretches along the flow gradient, producing elliptical deformation proportional to flow variation. ∎

## 26.3 Perihelion Precession

Orbital axes rotate through collapse torque:

**Definition 26.2** (Precession Rate):
...
**Theorem 26.2** (Resonant Pumping):
Near resonance, eccentricity oscillates:
...
**Definition 26.3** (Stability Boundary):
Orbits destabilize when:
...
**Theorem 26.3** (Circularization):
Eccentricity decays as:
$$e(t) = e_0 \exp(-t/\tau_c)$$
...
**Definition 26.4** (Laplace-Runge-Lenz):
...
**Theorem 26.4** (Kozai Oscillation):
For inclination i > 39.2°:
$$e^2 + \cos^2 i = \text{constant}$$
...
**Theorem 26.5** (Statistical Distribution):
