---
title: "Chapter 29: ψ-Auroras as Collapse Rebound Fields"
sidebar_label: "29. ψ-Auroras as Collapse Rebound Fields"
---
...
**Definition 29.1** (Rebound Field):
When collapse waves hit a planetary core:
...
**Theorem 29.1** (Luminous Excitation):
...
*Proof*:
Interference between incident and reflected collapse waves creates energy density fluctuations. These excite atmospheric atoms, with emission intensity proportional to the square of total field amplitude. ∎

## 29.3 Polar Concentration

Auroras favor high latitudes:

**Definition 29.2** (Polar Focusing):
Collapse channels along field lines:
...
**Theorem 29.2** (Spatial Structure):
Curtain spacing obeys:
...
**Definition 29.3** (Chromatic Layers):
Emission altitude depends on:
...
**Theorem 29.3** (Oscillation Modes):
Pulsation frequency:
$$f = \frac{c_\psi}{4H}$$
...
**Definition 29.4** (Storm Coupling):
...
**Theorem 29.4** (Hemispheric Symmetry):
North and south aurora satisfy:
...
**Definition 29.5** (Oval Equation):
The auroral oval follows:
...
**Theorem 29.5** (Comparative Aurora):
Aurora strength scales as:
...
1. **Height Correlation**: Aurora altitude anti-correlates with solar wind pressure
2. **Frequency Spectrum**: Pulsations match atmospheric resonances
3. **Magnetic Linking**: Conjugate aurora show quantum correlations
4. **Planetary Dependence**: Aurora strength follows collapse parameters
5. **Fine Structure**: Sub-kilometer filaments from collapse interference
