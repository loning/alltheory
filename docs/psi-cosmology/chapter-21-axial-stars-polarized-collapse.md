---
title: "Chapter 21: ψ-Axial Stars and Polarized Collapse"
sidebar_label: "21. ψ-Axial Stars and Polarized Collapse"
---
...
**Definition 21.1** (Axial Collapse):
A star becomes axial when:
...
**Theorem 21.1** (Polarization Growth):
Axial asymmetry amplifies through:
...
*Proof*:
Linear stability analysis of spherical collapse shows l=2 modes become unstable above critical rotation or density. Nonlinear saturation occurs when back-reaction balances growth. ∎

## 21.3 Magnetic Field Generation

Axial collapse generates magnetic fields:

**Definition 21.2** (Collapse Magnetism):
...
**Theorem 21.2** (Polar Jets):
Along the axis, matter accelerates:
...
**Theorem 21.3** (Equatorial Disk):
Matter accumulates at the equator when:
$$\frac{\partial\psi}{\partial z}\bigg|_{z=0} > \psi_{crit}$$

Forming disks with thickness:
...
**Definition 21.4** (Stokes Parameters):
...
**Theorem 21.4** (Axial Precession):
The symmetry axis precesses:
...
**Definition 21.5** (Magnetospheric Trap):
...
**Theorem 21.5** (Lighthouse Effect):
Radiation beams when:
