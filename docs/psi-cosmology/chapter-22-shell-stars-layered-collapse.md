---
title: "Chapter 22: ψ-Shell Stars and Layered Collapse Surfaces"
sidebar_label: "22. ψ-Shell Stars and Layered Collapse"
---
...
**Definition 22.1** (Shell Condition):
Shells form when the collapse gradient becomes discontinuous:
...
**Theorem 22.1** (Shell Stability):
A shell remains stable when:
...
*Proof*:
Linear perturbation analysis shows that positive ω² ensures oscillatory rather than exponential behavior. The first term provides pressure support, the second gravitational restoration. ∎

## 22.3 Inter-Shell Boundaries

Between shells lie transition regions:

**Definition 22.2** (Boundary Layer):
...
**Theorem 22.3** (Composition Layers):
Element abundance follows shell structure:
...
**Definition 22.4** (Shell Luminosity):
...
**Theorem 22.4** (Merger Criterion):
Adjacent shells merge when:
...
**Theorem 22.5** (Sequential Ejection):
During death, shells eject when:
