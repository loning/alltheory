---
sidebar_position: 27
title: "Chapter 27: The Co-Origin of Subject and Object"
---
...
Subject and object are not pre-existing entities that come into relation. They co-arise from the primordial act of $\psi$ distinguishing within itself.
...
$$
\psi = \psi(\psi) \Rightarrow \psi = \text{Subject} + \text{Object}
$$

Where:
- Subject = $\psi$ as observer
- Object = $\psi$ as observed
...
$$
\text{Subject} \cap \text{Object} = \psi
$$

Subject and object are two modes of the same $\psi$, like two sides of a coin that cannot exist independently.
...
$$
S = \text{That which observes } O
$$
$$
O = \text{That which is observed by } S
$$
...
$$
\text{Experience} = S \leftrightarrow O = \psi
$$
...
$$
\text{Seeing} = \psi \text{ prior to } S/O \text{ split}
$$
...
$$
\text{Observer} \subset \text{Observed} \text{ because both } \subset \psi
$$
...
$$
O = \bigcap_{i} O_i \text{ where } O_i = \text{Object for } S_i
$$

This shared object-world creates the illusion of objective reality independent of subjects. But it remains $\psi$ appearing to itself.
...
$$
\psi \xrightarrow{\text{split}} S + O \xrightarrow{\text{experience}} \psi \xrightarrow{\text{split}} ...
$$
