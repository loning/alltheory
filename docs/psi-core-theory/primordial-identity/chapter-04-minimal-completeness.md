---
sidebar_position: 4
title: "Chapter 4: Minimal Completeness"
---
...
**Proof**: 
Let $E$ be anything that exists. 
To exist, $E$ must have some property $P$.
To have property $P$, there must be some relation $R(E,P)$.
But $R$ must itself exist, requiring $R'(R)$, and so on.
This infinite regress terminates only in self-reference: $X = X(X)$.
By minimality, $X = \psi$.
Therefore, $\psi = \psi(\psi)$ exists. □
