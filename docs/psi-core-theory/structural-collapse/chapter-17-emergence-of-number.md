---
sidebar_position: 17
title: "Chapter 17: The Emergence of Number"
---
...
$$
\begin{align}
0 &= \emptyset = \psi|_{\text{symmetric}} \\
1 &= \{0\} = \{\psi|_{\text{symmetric}}\} = \psi|_{\text{first}} \\
2 &= \{0, 1\} = \psi|_{\text{second}} \\
3 &= \{0, 1, 2\} = \psi|_{\text{third}} \\
&\vdots
\end{align}
$$
...
1. $0 \in \mathbb{N}$ (the void state exists)
2. $n \in \mathbb{N} \Rightarrow S(n) \in \mathbb{N}$ (self-reference iterates)
3. $\forall n: S(n) \neq 0$ (distinction is irreversible)
4. $S(m) = S(n) \Rightarrow m = n$ (each collapse is unique)
